...
Original file is located at
    https://colab.research.google.com/drive/1sJ7ABkL01GHoY1dEEi1CgnJ56TYqU_9w
...
# TODO: Replace <FILL IN> with appropriate code
wordCountsGrouped = wordsGrouped.map(lambda pair: (pair[0], sum(list(pair[1]))))
...
def wordCount(wordListRDD):
    ...
    return (wordListRDD.map(lambda a: (a, 1)).reduceByKey(lambda x, y: x + y))
...
# TODO: Replace <FILL IN> with appropriate code
top10WordsAndCounts = wordCount(shakespeareWordsRDD).takeOrdered(10, key = lambda pair: (-1)*pair[1])
